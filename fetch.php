...
<body>
    <?php
    // id20794246_root,Ise@1234 ,id20794246_minar
        // Connect to the database
        $conn = new mysqli('localhost', 'id20893378_yashu', 'Yashu@123', 'id20893378_yashwanthks');
        ...
        if ($id && $name && $course && $email && $phone) {
            ...
            echo '<a href="last_email.html?email=' . urlencode($email) . '"><button>Next page</button></a>';
