...
echo "<script type='text/javascript'> document.location = 'index1.html'; </script>";
} else{
...
<div class="signup-form">
	...
	<div class="text-center small">If You Want Go For Home Page? <a href="index.html">Home Page</a></div>
</div>
</body>
</html>