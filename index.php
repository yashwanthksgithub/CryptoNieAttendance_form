...
<div class="signup-form">
    <form  method="post">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" name="email" pattern="[0-9]{4}[a-zA-Z]{2}_[a-zA-Z]+_[a-zA-Z]+@nie\.ac\.in" name="studentEmail" placeholder="Use College Email ID Only" required="required">
        </div>
		<div class="form-group">
	...
	<div class="text-center big">Already have an account? <a href="login.php">Login here</a></div>
	<div class="text-center big">Go back to Home Page? <a href="index.html">Home Page</a></div>
</div>
</body>
</html>